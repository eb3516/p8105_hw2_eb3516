...
Of those recruited, 389 developed MCI. The average baseline age is 65.
Of the women in the study, r round(nrow(filter(baseline_df,
sex==“Female”, apoe4==“Carrier”))/nrow(filter(baseline_df,
sex==“Female”)) are APOE4 carriers.
