...
There were `r nrow(baseline_df)` participants recruited. We now omit those who do not have an age of onset for MCI.
...
Of those recruited, `r nrow(baseline_df)` developed MCI.
